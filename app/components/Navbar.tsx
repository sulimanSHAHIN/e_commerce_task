        ...
        {activeTab === "all" && (
          <div className="flex gap-4 items-center">
            <input
              ...
              className="px-4 py-2 border placeholder-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600 shadow-sm transition w-56"
            />
